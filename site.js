(function () {
  const state = {
    lang: localStorage.getItem("toshibo-smart-home-lang") || "zh"
  };
  ...
  function renderProductDetail() {
    ...
    document.title = `${productName(product)} | TOSHIBO`;
      ...
      <section class="detail-hero">
        <div class="detail-copy">
          ...
          <div class="detail-actions">
            <strong>${product.price}</strong>
            <a class="primary-btn" href="mailto:hello@toshibo-home.example">${t("detail.contact")}</a>
          </div>
  ...
  function applyLanguage(lang) {
    state.lang = lang;
    localStorage.setItem("toshibo-smart-home-lang", lang);
